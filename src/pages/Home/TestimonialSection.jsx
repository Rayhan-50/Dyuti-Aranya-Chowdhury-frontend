        ...
        <section className="relative w-full py-12 sm:py-16 md:py-20 lg:py-32 overflow-hidden bg-[#FF9F66]">
            ...
            <div
                ...
                style={{
                    ...
                    backgroundColor: '#FF9F66' // Fallback
                }}
            ></div>
            ...
            <div className="w-full relative z-10">
                ...
                <div className="mt-12 sm:mt-16 lg:mt-20 relative w-full overflow-hidden rounded-3xl sm:rounded-[3rem] bg-cover bg-center"
                    style={{
                        // backgroundImage: `url(${frame24})`,
